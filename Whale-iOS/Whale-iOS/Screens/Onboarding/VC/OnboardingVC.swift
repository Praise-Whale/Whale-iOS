...
class OnboardingVC: UIViewController {
    ...
    func setOnboardingData() {
        ...
        onboardingPageControl.numberOfPages = onboardingArray.count
    }
    ...
    private func indexOfMajorCell() -> Int {
        ...
        let safeIndex = max(0, min(onboardingArray.count - 1, index))
        return safeIndex
    }
...
//        let pc = sender
//
//        onboardingCV.scrollToItem(at: IndexPath(item: pc.currentPage, section: 0), at: .centeredHorizontally, animated: true)
//    }
}
